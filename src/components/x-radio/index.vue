<style scoped="" lang="less">
    ...
    /*radio默认样式*/
    .x-radio-default {
        background-image: url("../../assets/images/defaultCheck.png");
    ...
    .x-radio-alignright-default {
        background-image: url("../../assets/images/defaultCheck1.8.png");
        background-position: center center;
        margin-right: 0 !important;
    }

    .x-radio-alignright-checked {
        background-image: url("../../assets/images/checked1.8.png");
        background-position: center center;
        margin-right: 0 !important;
    }
