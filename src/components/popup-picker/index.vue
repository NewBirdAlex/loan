<template>
  ...
  <div>
    <x-ceil :label="title" :value="formatToStr" @click.native="onClick" v-show="showCell" :noneCeil="noneCeil">
      <popup v-model="showValue" slot="right" class="vux-popup-picker" :id="`vux-popup-picker-${uuid}`"
             @on-hide="onPopupHide" @on-show="onPopupShow">
        <div class="vux-popup-picker-container">
          <div class="vux-popup-picker-header">
            <flexbox>
              <flexbox-item class="vux-popup-picker-header-menu vux-popup-picker-cancel" @click.native.stop="onHide(false)">
                取消
              </flexbox-item>
              <flexbox-item class="vux-popup-picker-header-menu vux-popup-picker-header-menu-right"
                            @click.native.stop="onHide(true)">确定
              </flexbox-item>
            </flexbox>
          </div>
          <picker
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onClick () {
        !this.disabled && (this.showValue = true)
      },
      onHide (type) {
